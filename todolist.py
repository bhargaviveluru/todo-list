...
def welcome_message():
    print(Fore.GREEN + f"Welcome, to bhargavi To-Do List App." + Style.RESET_ALL)
...
def main():
    ...
    while True:
        ...
        if choice == '1':
            ...
            print(Fore.BLUE + f'Exiting the Bhargavi To-Do List App. Thank you for using it!' + Style.RESET_ALL)
            break
        else:
